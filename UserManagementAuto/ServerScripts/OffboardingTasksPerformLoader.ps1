...
Try {
    If (Test-Path "$global:usrMgmtServerSource\ServerScripts\OffboardingTasksCreate.ps1") { 
        ...
        Copy-Item -Path "$global:usrMgmtServerSource\ServerScripts\OffboardingTasksPerformLoader.ps1" -Destination "$global:usrMgmtLocalPath\Server\OffboardingTasksPerformLoader.ps1" -Force
        Copy-Item -Path "$global:usrMgmtServerSource\ServerScripts\OffboardingTasksPerform.ps1" -Destination "$global:usrMgmtLocalPath\Server\OffboardingTasksPerform.ps1" -Force
    }
} Catch {}


# then load the locally copied script and get started...
If (Test-Path "$global:usrMgmtLocalPath\Server\OffboardingTasksPerform.ps1") { 
    #  
    ...
    . "$global:usrMgmtLocalPath\Server\OffboardingTasksPerform.ps1"
